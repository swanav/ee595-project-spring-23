    ...
    if (flow_monitor)
    {
        ...
        for (std::map<FlowId, FlowMonitor::FlowStats>::const_iterator i = stats.begin (); i != stats.end (); ++i) {
            ...
            throughput[i->first] =
                ...
                1024;
            std::cout << "\tThroughput: " << throughput[i->first] << " Kbps" << std::endl;
            throughputFile << throughput[i->first] << std::endl;
        }
